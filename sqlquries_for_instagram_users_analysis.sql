...
/*3. Task: Identify the winner of the contest and provide their details to the team*/
...
select commoly_used_hashtags from (
select tag_id,tag_name as commoly_used_hashtags,count(*) as hashtags_count from tags t
